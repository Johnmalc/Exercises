 ...
 * @author malcjohn
 * Aufgabe 3:
 * Sortieren Sie einen Array von Flie�komma-Zahlen (aufsteigend).
 * Initialisieren Sie den Array auch �ber Tastatureingabe.
 * 
 * Vorgehen (lineare Suche):
 * Ab 1. Element nach gr��ter Zahl suchen, 1. Element mit dieser tauschen.
 * Danach ab 2. Element nach (zweit)gr��ter Zahl suchen, mit 2. Element tauschen
