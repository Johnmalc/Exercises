...
public class Aufgabe4 
{
  ...
  public static void main(String[] args) 
  {
    ...
    // Starte das Programm mit einer Überschrift
    System.out.println("===================");
    ...
    while (auswahl != 99) 
    {
      ...
      case 1: // eingeben
      	...
      	if (stu.valid)
      	{
      		over = IOTools.readInteger
      				("Daten vorhanden, ueberschreiben? (ja=1): ");
      		if (over != 1) break;
      	}
	   ...
	   case 2: // ausgeben
        ...
        case 3: // Index wechseln
         	...
         	stu = studis[index];
         	System.out.println("Daten " + (stu.valid?"":"nicht ") + "vorhanden");
          	break;
